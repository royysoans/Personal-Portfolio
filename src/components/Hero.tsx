...
function CodeWindow() {
  ...
  return (
    ...
    >
      ...
      {/* Code body */}
      <div className="p-5 font-mono text-[13px] leading-6 min-h-[240px] text-[#EAD7C6] bg-[#1B130E]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.h1 variants={itemVariants}
              className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-6 text-[#18181B]"
            ...
            <motion.div variants={itemVariants} className="mb-8">
              <p className="text-lg text-[#71717A] leading-relaxed">Software Engineer & Full-Stack Web Developer.</p>
              <p className="text-lg text-[#71717A] leading-relaxed">Building thoughtful digital products.</p>
            </motion.div>
